...
export default function SeasonFormModal({
  ...
  return (
    <div className="fixed inset-0 bg-black/80 backdrop-blur-sm z-50 flex items-center justify-center p-4 animate-fade-in">
      <div className="bg-slate-900 border border-slate-800 rounded-3xl w-full max-w-xl shadow-2xl flex flex-col max-h-[90vh]">
          ...
          <form onSubmit={handleFormSubmit} className="flex flex-col flex-1 overflow-hidden">
            <div className="overflow-y-auto px-6 py-5 space-y-5 flex-1">
              <div className="space-y-1.5">
                ...
                <select
                  ...
                  className="w-full px-4 py-2.5 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 text-sm focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500 cursor-pointer"
                  required
                >
              ...
              <div className="space-y-1.5">
                ...
                <input
                  ...
                  className="w-full px-4 py-2.5 bg-slate-950/60 border border-slate-800 rounded-xl text-slate-200 text-sm placeholder-slate-600 focus:outline-none focus:ring-2 focus:ring-indigo-500/50 focus:border-indigo-500"
                  required
                />
              </div>
              ...
              <div>
                ...
                {showCustomSliders && (
                  <div className="p-4 border border-slate-800 bg-slate-950/50 rounded-2xl space-y-4 animate-in fade-in duration-200">
            ...
            <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-800 flex-shrink-0">
              ...
              <button
                ...
                className="flex items-center gap-2 px-5 py-2 text-xs font-bold bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl transition-colors cursor-pointer disabled:opacity-40 disabled:pointer-events-none min-w-[120px] justify-center"
              >
          ...
          <div className="flex flex-col flex-1 overflow-hidden">
            <div className="overflow-y-auto px-6 py-5 space-y-4 flex-1">
              ...
              <div className="space-y-3">
                {affectedBookings.map((booking) => {
                  ...
                  return (
                    <div key={booking.id} className="p-4 rounded-xl bg-slate-800/40 border border-slate-800/60 space-y-3">
                      <div className="flex items-start gap-2">
                        ...
                        <div className="flex-1 min-w-0">
                          <p className="text-xs font-semibold text-slate-200">{booking.guestName}</p>
                      ...
                      {ba?.action === "manual" && (
                        <input
                          ...
                          className="w-full px-3 py-2 bg-slate-950/60 border border-slate-700 rounded-lg text-slate-200 text-xs placeholder-slate-600 focus:outline-none focus:ring-1 focus:ring-indigo-500"
                        />
                      )}
                    </div>
                  );
            ...
            <div className="flex items-center justify-end gap-3 px-6 py-4 border-t border-slate-800 flex-shrink-0">
              ...
              <button
                ...
                disabled={isLoading}
                className="flex items-center gap-2 px-5 py-2 text-xs font-bold bg-indigo-600 hover:bg-indigo-500 text-white rounded-xl transition-colors cursor-pointer disabled:opacity-40 disabled:pointer-events-none min-w-[160px] justify-center"
              >
                ...
                <div className="space-y-2">
                  ...
                  {affectedBookings.map((b) => (
                    <div key={b.id} className="flex items-start gap-3 p-3 rounded-xl bg-slate-800/40 border border-slate-800/60">
                      ...
                      />
                      <div className="flex-1 min-w-0">
                        <p className="text-xs font-semibold text-slate-200">{b.guestName}</p>
                        <div className="flex items-center gap-1.5 text-[10px] text-slate-500 mt-0.5">
                          <Calendar className="w-3 h-3" />
                      ...
                      <span className="text-xs font-semibold text-slate-300">{b.totalPrice}€</span>
                    </div>
                  ))}
                </div>
              ) : (
                <p className="text-xs text-slate-400">No hay reservas futuras afectadas.</p>
              )}
